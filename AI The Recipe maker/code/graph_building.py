...
df = pd.read_csv(r'C:\Users\atche\Desktop\Study zone\AI\Main_Project\data\srep00196-s2.csv',skiprows=4,header=None)
...
recipe = pd.read_csv(r'C:\Users\atche\Desktop\Study zone\AI\Main_Project\data\srep00196-s3.csv',skiprows=3,sep='\t')
...
df_backbone.to_csv(r'C:\Users\atche\Desktop\Study zone\AI\Main_Project\data\backbone.csv',index=False)
print('use this backbone.csv in cytoscape to make the final graph')
