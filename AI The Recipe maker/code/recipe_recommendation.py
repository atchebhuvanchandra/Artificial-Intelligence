...
def plot_similardishes(idx,xlim):
    match = yum_ingr2.iloc[yum_cos[idx].argsort()[-21:-1]][::-1]
    print('Top 20 matched items to the given recipe')
    print(match)
...
if __name__ == '__main__':
    yum_ingr = pd.read_pickle(r'C:\Main_Project\data\yummly_ingr.pkl')
    yum_ingrX = pd.read_pickle(r'C:\Main_Project\data\yummly_ingrX.pkl')
    yum_tfidf = pd.read_pickle(r'C:\Main_Project\data\yum_tfidf.pkl')
